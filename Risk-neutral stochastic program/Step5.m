...
for r=1:length(alpha)
    riskAdverse(alpha(r), beta,Target,index,m,n,T,c,b,prob,geo_mean_perQ,ret_sce1,ret_sce2,ret_sce3,ret_sce4,ret_sce5,ret_sce6,ret_sce7,ret_sce8,ret_sce9,ret_sce10)
end
 

%%%Function of risk-adverse stochastic linear program 
function X=riskAdverse(alpha, beta,Target,index,m,n,T,c,b,prob,geo_mean_perQ,ret_sce1,ret_sce2,ret_sce3,ret_sce4,ret_sce5,ret_sce6,ret_sce7,ret_sce8,ret_sce9,ret_sce10)
