%Given the value of m ,get the portfolio for each target return,the initial x0
...
m=4;
usee=BenderDecomN(m,x0,geo_mean_perQ);
...
p3=usee(:,3)';
%add a virtual p4 for bar plot since they are the same
p4=p1;
